...
class CandidateScheduleRowReviewServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_registrar_can_revise_conflict_row_and_revalidate_it_as_warning(): void
    {
        ...
        app(CandidateScheduleRowReviewService::class)->revise($row, [
        ...
        $reviewedRow = CandidateScheduleRow::query()->where('generation_run_id', $run->id)->firstOrFail();

        $this->assertSame(CandidateScheduleRow::StatusWarning, $reviewedRow->status);
    ...
    public function test_revision_keeps_row_conflicted_when_hard_constraints_still_fail(): void
    {
        ...
        $this->assertSame(CandidateScheduleRow::StatusConflict, $reviewedRow->status);
    ...
    /**
     * @return array{ScheduleGenerationRun, CandidateScheduleRow, User, User}
     */
    private function draftReviewFixtures(): array
    {
        ...
        $row = CandidateScheduleRow::query()->create([
