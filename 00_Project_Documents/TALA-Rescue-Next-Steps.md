...
| TAL-96D5C2 | Planned; depends on TAL-96D5C1 | Full Regression, Security, and Integration-Readiness Gate after role/surface remediation stabilizes. |
...
Next primary boundary: **`Plan TAL-96D5C2`**. TAL-96D5C2 owns the full regression, security, and integration-readiness gate after the accepted role/surface remediation. It must reconcile its scope against the charter and current authorities before any execution. TAL-96D5D capacity benchmarking, Linear sync, push, PR creation, deployment, subagent use, destructive database actions, and external-service mutation remain unauthorized.
