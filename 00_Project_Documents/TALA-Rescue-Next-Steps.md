...
| TAL-96D5E1B | Next planning boundary; depends on cleaned TAL-96D5E1A | Registrar-Centered Operational Recovery across prerequisites, admissions, offerings, scheduling, enrollment, student records, and affected-role projections. |
| TAL-96D5E1C | Planned; blocked on verified and cleaned TAL-96D5E1B | Accounting and PayMongo Operational Recovery across assessments, account activity, payments, ledger, reconciliation, fallbacks, gates, and generated outputs. |
...
Next planning boundary: **`Plan TAL-96D5E1B`.** Reconcile the Registrar-centered operational recovery against the verified D5E1A findings before proposing implementation. Preserve normalized records and existing service boundaries; stop for any schema change, live-surface deletion or merge, office-ownership change, destructive action, external-provider action, or new dependency.
