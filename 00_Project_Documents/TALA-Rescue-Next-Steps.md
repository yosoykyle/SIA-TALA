...
| TAL-94D3 | Split approved; sub-slices pending | Revision UX, Notifications, and Role Acceptance. Complete TAL-94D3a-D3c vertically over the accepted TAL-94D2 revision domain. |
| TAL-94D3a | Done locally; pending explicit Linear sync | Revision Action and History UX |
| TAL-94D3b | Planned | Affected-User Email and Delivery Evidence: send queued code-defined email only to deduplicated affected students and previous/replacement faculty, with post-commit operational evidence and failure isolation. |
| TAL-94D3c | Planned | Schedule Projections and Cross-Role Acceptance: add the missing Faculty schedule projection, reconcile Student schedule presentation, and verify current Registrar, Academic Head, Faculty, Student, COR, cancellation, and denied-role behavior. |
...
Next primary boundary: **Plan TAL-94D3b**. Re-run the Ground-Truth Gate before planning affected-user email and delivery evidence.
