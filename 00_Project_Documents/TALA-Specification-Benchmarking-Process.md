...
| Official generated documents | Generated PDFs and QR verification are derived artifacts, not primary records. The source of truth remains enrollment, grade, ledger, student-record, and document-request data. |
...
| 2026-06-21 | Student status, readmission, transfer, completion/graduation | Inventory, BM-01/BM-02/SIA-01 rule, FS baseline, TS contract, reconciliation, SDD/checklist | Locked typed effective-dated transitions, assisted readmission/provenance review, reproducible graduation evaluation, and external credential/government boundary. |
| 2026-06-21 | Imports, exports, reports, external boundaries | Inventory, BM-01/BM-10/SIA-01 rule, FS baseline, TS contract, reconciliation, SDD/checklist | Locked private versioned import batches, preview/commit/audit, export allowlists, artifact lifecycle, and no DepEd/CHED/LIS-specific submission automation. |
| 2026-06-21 | Attendance, behavior, discipline, guidance, interventions | Inventory, BM-01/BM-05/SIA-01 rule, FS baseline, TS contract, reconciliation, SDD/checklist | Classified as benchmark-gated/deferred until typed evidence, privacy, notice/appeal, resolution, retention, and approved effect policies exist. |
...
| 7 - Official generated documents, document requests, PDF artifacts, and QR verification | `SPEC_LOCK_READY` (2026-06-21) | SIA document/request workflow, BM-13/BM-14/BM-15/BM-22/BM-23, FS, TS, reconciliation, SDD, COR verification controls, document request lifecycle services/resources, focused tests, and UAT rows were cross-checked. Authoritative-source issuance, private artifacts, source snapshots/checksums, opaque minimal-disclosure verification, revoke/supersede history, and release evidence are approved. Runtime still lacks a full official-document issuance table/service, COR PDF/QR/public verification route, private artifact lifecycle, claimant/representative release evidence, school-to-school Form 137 transfer evidence, template-versioned academic artifacts, and dedicated COR permissions. |
