...
The [Human-Centered Operations design definition](TALA-Experience-and-Official-Output-Design-Definition.md) is the approved production-translation companion for these surfaces. Its prototype is evidence, not a frontend runtime or source dependency.
...
- [TALA Experience and Official-Output Design Definition](./TALA-Experience-and-Official-Output-Design-Definition.md) — approved Human-Centered Operations rationale and production-stack translation; subordinate to the canonical product owners.
