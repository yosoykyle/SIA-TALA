...
| **Financial and transaction evidence** | Payment proof, promissory-note attachment, official receipt image | Preserve privately and link immutably to the payment, note, or accounting event. OCR may suggest references/amounts but never confirms payment, approval, or settlement. |
