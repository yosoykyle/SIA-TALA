...
> **Archived demonstration material — do not execute as current acceptance authority.** Its fixtures, task IDs, URLs, and expected behavior may be superseded by canonical 00–06 and later vertical slices.
...
The corrected 54-demand Cloud acceptance is recorded in [`TAL-96B2-Representative-Solver-Evidence.md`](../project-progress/TAL-96B2-Representative-Solver-Evidence.md). The replacement Cloud Run profile comparison, proportional-growth boundary, resource use, and cost evidence are recorded in [`TAL-96B3-Cloud-Run-Capacity-Benchmark.md`](../project-progress/TAL-96B3-Cloud-Run-Capacity-Benchmark.md). Do not describe the synthetic scheduling resources as the client's actual personnel or facilities, a universal maximum, or an accuracy benchmark.
