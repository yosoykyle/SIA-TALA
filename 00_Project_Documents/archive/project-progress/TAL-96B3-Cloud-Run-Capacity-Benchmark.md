...
> **Archived implementation evidence — not product, procurement, or execution authority.** These dated measurements remain bounded historical evidence; the Architecture Specification owns current deployment and capacity claims.
...
| Proportional 2x | 12 | 108 | 108 | 24 | 12 | Doubles both work and scheduling resources |
| Contention 2x | 12 | 108 | 108 | 12 | 6 | Doubles work while retaining baseline faculty and rooms |
| Proportional 4x | 24 | 216 | 216 | 48 | 24 | Explores an upper computational boundary |
