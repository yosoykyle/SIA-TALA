...
| CP-SAT scheduling | Registrar Workspace | Readiness review, solver-run setup, and benchmark-selected accessible candidate review with a canonical table | Understandable candidate assignments, constraints, quality, publication confirmation, and published Master Schedule |
