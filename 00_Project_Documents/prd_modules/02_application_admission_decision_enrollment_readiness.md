...
- Existing active correction and corrected resubmission remain available after public closing and after their due time; overdue stays `ActionNeeded`. The correction boundary does not stop an active correction, ongoing review, decisions, or credential work.
- After the correction boundary, issuing a new correction request requires an authorized extension of that boundary. Ordinary review, decisions, and credential work continue.
