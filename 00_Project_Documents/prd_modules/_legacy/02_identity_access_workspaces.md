...
> **Legacy input — not current product authority.** Preserved for traceability and bounded salvage review only. Canonical PRD 01 governs identity, access, roles, workspaces, and public entry.
