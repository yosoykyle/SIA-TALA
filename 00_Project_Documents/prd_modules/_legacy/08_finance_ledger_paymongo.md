...
> **Legacy input — not current product authority.** Preserved for traceability and bounded salvage review only. Canonical PRD 06 governs term accounts, payment evidence, exact-due PayMongo, outputs, operations, and assurance.
