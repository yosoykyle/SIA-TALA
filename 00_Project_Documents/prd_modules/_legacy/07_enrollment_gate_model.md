...
> **Legacy input — not current product authority.** Preserved for traceability and bounded salvage review only. Canonical PRD 04 replaces the generic gate model with the accepted Registration Case and five-checkpoint enrollment journey.
