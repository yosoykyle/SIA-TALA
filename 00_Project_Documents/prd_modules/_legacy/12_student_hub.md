...
> **Legacy input — not current product authority.** Preserved for traceability and bounded salvage review only. Student-facing behavior is governed by the owning canonical journey PRDs and their UI authority.
