...
> **Legacy split input — not current product authority.** Clinic 3 defines Academic Setup, Offerings, Teaching Resources, and the Published Timetable as one journey in [PRD 03 — Academic Setup, Offerings, and Published Timetable](../03_academic_setup_offerings_published_timetable.md). The content below is preserved only as implementation-salvage and historical requirement evidence. It must not govern implementation or task derivation.
...
- **Rules:**
  ...
  8. Requested or preferred-time input and optimization are not part of the approved scope and are not planned. V1 records and enforces recurring unavailable blocks only.
