...
> **Legacy input — not current product authority.** Preserved for traceability and bounded salvage review only. Canonical `00`–`06`, the UI Surface Blueprint, and the Architecture Specification govern the rebaselined product.
