...
- The selected host direction remains a self-managed [Hostinger KVM 2 VPS](https://www.hostinger.com/ph/vps-hosting), subject to procurement-time specification and price recheck. Hostinger's included weekly VPS backups and controlled pre-change snapshots are supplemental full-host recovery points only.
