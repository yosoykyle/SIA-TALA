...
- [x] Mirror completed SDD-06A/06B/06C evidence to Linear as `TAL-24`, `TAL-25`, and `TAL-26`; continue creating one testable Linear issue per subsequent SDD-06 slice.
