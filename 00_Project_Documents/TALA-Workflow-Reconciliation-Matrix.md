...
| Student status and completion | Section D / SDD-07D-E | Mostly `MISSING`/`RECONCILE`; completion boundary core, full lifecycle supporting/deferred |
| Imports, exports, reports | Shared/external rows / SDD-09 | Controlled foundation import partly aligned; generic exports supporting, portals external |
| Attendance, behavior, guidance | Section D / SDD-08B | `BENCHMARK_GATE`; `UAT_DEFERRED` until evidence/policy exists |
